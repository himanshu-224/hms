...
from test_bootstrap.forms import TestForm, ComplainForm
from test_bootstrap.forms import TestModelForm, TestInlineForm, WidgetsForm,ProfileForm
...
# a simple form for the profile page
